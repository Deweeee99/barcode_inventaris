...
class _DashboardScreenState extends State<DashboardScreen> {
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text("Petugas Lapangan", style: GoogleFonts.poppins(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.black)),
                    ],
                  ),
                  Stack(
                    children: [
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("159", style: GoogleFonts.poppins(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.white)),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 12),
                          Text("5", style: GoogleFonts.poppins(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.black)),
        ...
        child: SizedBox(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Row(
                children: [
                  // 3. ICON INI KITA JADIKAN MUTASI (Sebelumnya Tagging)
  ...
  // 4. Update Helper Menu Cepat biar terima onTap
  Widget _buildQuickMenu({
    required IconData icon, 
    required String label, 
    required Color color, 
    required Color iconColor,
    VoidCallback? onTap, // Parameter baru buat aksi klik
  }) {
    return GestureDetector( // Bungkus pake GestureDetector
      onTap: onTap,
      child: Column(
        children: [
          Container(
